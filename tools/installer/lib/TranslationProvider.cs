...
namespace Resurgence
{
    ...
    public class TranslationProvider
    {
        ...
        {
            Translation = new Resurgence.Translation.Translation(Language);
        ...
        {
            Translation = new Resurgence.Translation.Translation(LanguagesDirectory, Language);
        ...
        public string Language
        {
            ...
            set
            {
                ...
                if (Translation == null)
                    Translation = new Resurgence.Translation.Translation(value);
                else
